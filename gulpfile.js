...
gulp.task(
  ...
  gulp.series(
    clean,
    'svg',
    gulp.parallel(styles, templates, images, fonts, scriptsDev),
    gulp.parallel(watch, server)
  )
);
gulp.task(
  'dev',
  gulp.series(clean,'svg', gulp.parallel(styles, templates, images, fonts, scriptsDev))
);
gulp.task(
  'prod',
  gulp.series(clean,'svg', gulp.parallel(styles, templates, images, fonts, scriptsProd))
);
